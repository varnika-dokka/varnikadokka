        ...
        <FadeIn delay={0.5}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-8 rounded-3xl bg-white/60 backdrop-blur-sm border border-amber-200/70">
              ...
              <p className="text-muted-foreground leading-relaxed text-sm">Before I think about what to build, I want to understand who I'm building for: what they're struggling with, what they've already tried, and what would genuinely make their lives easier.</p>
            </div>
            <div className="p-8 rounded-3xl bg-white/60 backdrop-blur-sm border border-violet-200/70">
              ...
              <p className="text-muted-foreground leading-relaxed text-sm">I'm drawn to the work of taking something messy and making it feel obvious, whether that's a dashboard showing housing data or a product that cuts scope by 40% to actually ship on time.</p>
            </div>
            <div className="p-8 rounded-3xl bg-white/60 backdrop-blur-sm border border-rose-200/70">
              ...
              <p className="text-muted-foreground leading-relaxed text-sm">I care about whether what I'm building actually solves something. I'll advocate for the features users asked for and keep pushing until what we ship makes a real impact.</p>
            </div>
          </div>
        </FadeIn>
      </section>
